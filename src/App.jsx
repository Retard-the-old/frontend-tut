      ...
      <section style={{ padding:"140px 48px", position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ maxWidth:1100, margin:"0 auto", position:"relative", zIndex:1 }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:mob?"1fr 1fr":"repeat(4, 1fr)", gap:16, maxWidth:mob?400:1100, margin:"0 auto", alignItems:"stretch" }}>
            {[{r:3,lab:"Covers subscription",net:(3*PRICE*L1_RATE)},{r:10,lab:"Meaningful income",net:(10*PRICE*L1_RATE)},{r:25,lab:"Exceeds part-time jobs",net:(25*PRICE*L1_RATE)},{r:50,lab:"Real income stream",net:(50*PRICE*L1_RATE)}].map(function(e,ei){return (
