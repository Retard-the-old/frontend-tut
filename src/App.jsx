        ...
        {tab === "settings" && <div>
          ...
          <div style={{ background:"#131315", borderRadius:14, padding:mob?16:22, border:"1px solid rgba(255,255,255,0.06)", marginBottom:16, boxSizing:"border-box" }}>
            ...
            <div style={{ display:"grid", gridTemplateColumns:mob?"1fr":"1fr 1fr", gap:mob?12:16 }}>
              <div>
                ...
                <input defaultValue={u.name} style={{ width:"100%", padding:"11px 14px", borderRadius:10, border:"1px solid rgba(255,255,255,0.1)", fontSize:14, outline:"none", boxSizing:"border-box", fontFamily:"'Plus Jakarta Sans',sans-serif", background:"#0a0a0c", color:"#d4d4d8" }} />
              </div>
              <div>
                <label style={{ display:"block", fontSize:11, fontWeight:600, color:"#52525b", marginBottom:4 }}>Email Address</label>
                <input defaultValue={u.email} style={{ width:"100%", padding:"11px 14px", borderRadius:10, border:"1px solid rgba(255,255,255,0.1)", fontSize:14, outline:"none", boxSizing:"border-box", fontFamily:"'Plus Jakarta Sans',sans-serif", background:"#0a0a0c", color:"#d4d4d8" }} />
              </div>
              <div>
                <label style={{ display:"block", fontSize:11, fontWeight:600, color:"#52525b", marginBottom:4 }}>Phone Number</label>
                <input defaultValue={u.phone} style={{ width:"100%", padding:"11px 14px", borderRadius:10, border:"1px solid rgba(255,255,255,0.1)", fontSize:14, outline:"none", boxSizing:"border-box", fontFamily:"'Plus Jakarta Sans',sans-serif", background:"#0a0a0c", color:"#d4d4d8" }} />
              </div>
              <div>
            ...
            <div style={{ marginTop:16, display:"flex", justifyContent:"flex-end" }}>
              <Btn style={{ fontSize:12, padding:"10px 24px" }}>Save Changes</Btn>
            </div>
          </div>

          <div style={{ background:"#131315", borderRadius:14, padding:mob?16:22, border:"1px solid rgba(255,255,255,0.06)", marginBottom:16, boxSizing:"border-box" }}>
            <h3 style={{ fontSize:14, fontWeight:700, margin:"0 0 16px", color:"#d4d4d8" }}>Change Password</h3>
            <div style={{ display:"grid", gap:14, maxWidth:400 }}>
              <div>
                ...
                <input type="password" placeholder="Enter current password" style={{ width:"100%", padding:"11px 14px", borderRadius:10, border:"1px solid rgba(255,255,255,0.1)", fontSize:14, outline:"none", boxSizing:"border-box", fontFamily:"'Plus Jakarta Sans',sans-serif", background:"#0a0a0c", color:"#d4d4d8" }} />
              </div>
              <div>
                <label style={{ display:"block", fontSize:11, fontWeight:600, color:"#52525b", marginBottom:4 }}>New Password</label>
                <input type="password" placeholder="Enter new password" style={{ width:"100%", padding:"11px 14px", borderRadius:10, border:"1px solid rgba(255,255,255,0.1)", fontSize:14, outline:"none", boxSizing:"border-box", fontFamily:"'Plus Jakarta Sans',sans-serif", background:"#0a0a0c", color:"#d4d4d8" }} />
              </div>
              <div>
                <label style={{ display:"block", fontSize:11, fontWeight:600, color:"#52525b", marginBottom:4 }}>Confirm New Password</label>
                <input type="password" placeholder="Confirm new password" style={{ width:"100%", padding:"11px 14px", borderRadius:10, border:"1px solid rgba(255,255,255,0.1)", fontSize:14, outline:"none", boxSizing:"border-box", fontFamily:"'Plus Jakarta Sans',sans-serif", background:"#0a0a0c", color:"#d4d4d8" }} />
              </div>
            </div>
            <div style={{ marginTop:16, display:"flex", justifyContent:"flex-end" }}>
              <Btn style={{ fontSize:12, padding:"10px 24px" }}>Update Password</Btn>
            </div>
          </div>

          <div style={{ display:"grid", gridTemplateColumns:mob?"1fr":"1fr 1fr", gap:16, marginBottom:16, alignItems:"stretch" }}>
            <div style={{ background:"#131315", borderRadius:14, padding:mob?16:22, border:"1px solid rgba(255,255,255,0.06)" }}>
              <h3 style={{ fontSize:14, fontWeight:700, margin:"0 0 16px", color:"#d4d4d8" }}>Payment Method</h3>
              <div style={{ display:"flex", alignItems:"center", gap:12, padding:14, background:"rgba(255,255,255,0.03)", borderRadius:10, border:"1px solid rgba(255,255,255,0.06)", marginBottom:12 }}>
                <div style={{ width:40, height:26, borderRadius:4, background:"#111113", display:"flex", alignItems:"center", justifyContent:"center", fontSize:10, color:"#fff", fontWeight:700 }}>VISA</div>
                <div>
                  <div style={{ fontSize:13, fontWeight:600, color:"#d4d4d8" }}>{u.paymentMethod}</div>
                  <div style={{ fontSize:11, color:"#52525b" }}>{"Expires 08/2028"}</div>
                </div>
              </div>
              <div style={{ fontSize:11, color:"#52525b", marginBottom:12 }}>{"Next charge: " + u.nextBilling + " - $" + PRICE}</div>
              <button style={{ width:"100%", padding:"10px", borderRadius:8, border:"1px solid rgba(255,255,255,0.1)", background:"#131315", fontSize:12, fontWeight:600, color:"#d4d4d8", cursor:"pointer" }}>Update Payment Method</button>
              <div style={{ fontSize:10, color:"#52525b", marginTop:8, textAlign:"center" }}>Processed securely via MamoPay</div>
            </div>

            <div style={{ background:"#131315", borderRadius:14, padding:mob?16:22, border:"1px solid rgba(255,255,255,0.06)" }}>
              <h3 style={{ fontSize:14, fontWeight:700, margin:"0 0 16px", color:"#d4d4d8" }}>Payout Details</h3>
              <div>
                <label style={{ display:"block", fontSize:11, fontWeight:600, color:"#52525b", marginBottom:4 }}>IBAN</label>
                <input defaultValue={u.iban} style={{ width:"100%", padding:"11px 14px", borderRadius:10, border:"1px solid rgba(255,255,255,0.1)", fontSize:13, fontFamily:"monospace", outline:"none", boxSizing:"border-box", marginBottom:12, background:"#0a0a0c", color:"#d4d4d8" }} />
              </div>
              <div style={{ padding:12, background:"rgba(255,255,255,0.03)", borderRadius:8, marginBottom:12 }}>
                <div style={{ fontSize:11, color:"#52525b" }}>Payout Schedule</div>
                <div style={{ fontSize:13, fontWeight:600, color:"#d4d4d8" }}>Every Tuesday via MamoPay</div>
                <div style={{ fontSize:11, color:"#52525b", marginTop:2 }}>Minimum payout: AED 50</div>
              </div>
              <button style={{ width:"100%", padding:"10px", borderRadius:8, border:"none", background:"#111113", fontSize:12, fontWeight:600, color:"#fff", cursor:"pointer" }}>Save IBAN</button>
            </div>
          </div>

          <div style={{ background:"#131315", borderRadius:14, padding:mob?16:22, border:"1px solid rgba(255,255,255,0.06)", marginBottom:16, boxSizing:"border-box" }}>
            <h3 style={{ fontSize:14, fontWeight:700, margin:"0 0 12px", color:"#d4d4d8" }}>Account Details</h3>
            <div style={{ display:"grid", gridTemplateColumns:mob?"1fr":"1fr 1fr 1fr", gap:mob?10:16, alignItems:"stretch" }}>
              ...
              <div style={{ padding:14, background:"rgba(255,255,255,0.03)", borderRadius:10, textAlign:"center", display:"flex", flexDirection:"column", alignItems:"center" }}>
                <div style={{ fontSize:10, fontWeight:600, color:"#52525b", marginBottom:4 }}>REFERRED BY</div>
                <div style={{ fontSize:13, fontWeight:600, color:"#d4d4d8" }}>{u.referredBy}</div>
              </div>
              <div style={{ padding:14, background:"rgba(255,255,255,0.03)", borderRadius:10, textAlign:"center", display:"flex", flexDirection:"column", alignItems:"center" }}>
                <div style={{ fontSize:10, fontWeight:600, color:"#52525b", marginBottom:4 }}>LAST LOGIN</div>
                <div style={{ fontSize:13, fontWeight:600, color:"#d4d4d8" }}>{u.lastLogin}</div>
              </div>
            </div>
          </div>
          ...
          <div style={{ background:"#131315", borderRadius:14, padding:mob?16:22, border:"1px solid rgba(248,113,113,0.2)", boxSizing:"border-box" }}>
            ...
            <div style={{ display:"flex", flexDirection:mob?"column":"row", gap:12 }}>
              ...
              <button style={{ padding:"10px 20px", borderRadius:8, border:"1px solid rgba(248,113,113,0.2)", background:"#131315", fontSize:12, fontWeight:600, color:"#f87171", cursor:"pointer" }}>Delete Account</button>
            </div>
          </div>
        </div>}
        </div>}
