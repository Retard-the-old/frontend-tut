...
function LegalPage(props) {
  ...
  return (
    <div style={{ background:"#000000", minHeight:"100vh" }}>
      <nav style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"18px 48px", background:"#0d0d0d", borderBottom:"1px solid rgba(255,255,255,0.08)" }}>
      ...
      <div style={{ maxWidth:800, margin:"0 auto", padding:mob?"24px 16px 60px":"48px 24px 80px" }}>
        ...
        <h1 style={{ fontSize:32, fontWeight:800, color:"#ffffff", margin:"20px 0 32px" }}>{title}</h1>
        <div style={{ background:"#0d0d0d", borderRadius:16, padding:mob?"20px 18px":"36px 40px", border:"1px solid rgba(255,255,255,0.06)", fontSize:mob?13:14, color:"#94a3b8", lineHeight:1.9 }}>
          {children}
        </div>
      </div>
    </div>
