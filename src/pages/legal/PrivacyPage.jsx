...
function PrivacyPage(props) {
  ...
  return (
    <LegalPage go={go} title="Privacy Policy">
      <p style={{ fontSize:12, color:"#64748b", marginBottom:24 }}>Last updated: March 1, 2026</p>

      <h2 style={{ fontSize:18, fontWeight:700, color:"#ffffff", margin:"0 0 12px" }}>1. Information We Collect</h2>
      ...
      <h2 style={{ fontSize:18, fontWeight:700, color:"#ffffff", margin:"0 0 12px" }}>2. How We Use Your Information</h2>
      ...
      <h2 style={{ fontSize:18, fontWeight:700, color:"#ffffff", margin:"0 0 12px" }}>3. Data Sharing</h2>
      ...
      <h2 style={{ fontSize:18, fontWeight:700, color:"#ffffff", margin:"0 0 12px" }}>4. Data Security</h2>
      ...
      <h2 style={{ fontSize:18, fontWeight:700, color:"#ffffff", margin:"0 0 12px" }}>5. Data Retention</h2>
      ...
      <h2 style={{ fontSize:18, fontWeight:700, color:"#ffffff", margin:"0 0 12px" }}>6. Your Rights</h2>
      ...
      <h2 style={{ fontSize:18, fontWeight:700, color:"#ffffff", margin:"0 0 12px" }}>7. Cookies and Tracking</h2>
      ...
      <h2 style={{ fontSize:18, fontWeight:700, color:"#ffffff", margin:"0 0 12px" }}>8. Children</h2>
      ...
      <h2 style={{ fontSize:18, fontWeight:700, color:"#ffffff", margin:"0 0 12px" }}>9. Changes to This Policy</h2>
      ...
      <h2 style={{ fontSize:18, fontWeight:700, color:"#ffffff", margin:"0 0 12px" }}>10. Contact</h2>
