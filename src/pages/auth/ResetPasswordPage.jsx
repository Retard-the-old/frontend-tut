        ...
        <div style={{ maxWidth:400, width:"100%" }}>
          ...
          {validating ? (
            <div style={{ textAlign:"center", padding:"60px 0" }}>
              ...
              <p style={{ fontSize:14, color:"#94a3b8" }}>Validating your reset link...</p>
            </div>
          ) : !tokenValid ? (
            <div style={{ textAlign:"center" }}>
              ...
              <h3 style={{ fontSize:22, fontWeight:700, color:"#ffffff", margin:"0 0 8px" }}>Invalid or expired link</h3>
              <p style={{ fontSize:14, color:"#94a3b8", marginBottom:28, lineHeight:1.7 }}>This password reset link is no longer valid. It may have expired or already been used.</p>
              ...
              <div style={{ textAlign:"center" }}>
                <span onClick={function(){go("login")}} style={{ fontSize:13, color:"#94a3b8", cursor:"pointer" }}>Back to login</span>
              </div>
            </div>
          ) : done ? (
            <div style={{ textAlign:"center" }}>
              <div style={{ width:56, height:56, borderRadius:16, background:"linear-gradient(135deg, rgba(0,228,193,0.12), rgba(255,255,255,0.03))", border:"1px solid rgba(255,255,255,0.08)", display:"flex", alignItems:"center", justifyContent:"center", margin:"0 auto 24px" }}>
              ...
              <h3 style={{ fontSize:22, fontWeight:700, color:"#ffffff", margin:"0 0 8px" }}>Password reset complete</h3>
              <p style={{ fontSize:14, color:"#94a3b8", marginBottom:28, lineHeight:1.7 }}>Your password has been updated successfully. You can now log in with your new password.</p>
            ...
            <div>
              ...
              <h3 style={{ fontSize:24, fontWeight:700, color:"#ffffff", margin:"0 0 8px" }}>Set a new password</h3>
              {tokenEmail && <p style={{ fontSize:13, color:"#64748b", marginBottom:24 }}>{"for " + tokenEmail}</p>}
              ...
              <div style={{ marginBottom:20 }}>
                ...
                <div style={{ marginTop:8, display:"flex", flexDirection:"column", gap:4 }}>
                  {[["8+ characters", pass.length >= 8],["One uppercase letter",/[A-Z]/.test(pass)],["One number",/[0-9]/.test(pass)]].map(function(r){return <div key={r[0]} style={{ display:"flex", alignItems:"center", gap:6, fontSize:11, color:r[1] ? "rgb(0,228,193)" : "#64748b", transition:"color 0.3s" }}><span>{r[1] ? "\u2713" : "\u2022"}</span>{r[0]}</div>})}
                </div>
              </div>

              <div style={{ marginBottom:28 }}>
                <label style={{ display:"block", fontSize:12, fontWeight:600, color:"#94a3b8", marginBottom:6 }}>Confirm Password</label>
