    ...
    <div style={{ minHeight:"100vh", display:"flex", flexDirection:mob?"column":"row", background:"#000000" }}>
      ...
      <div style={{ flex:1, display:"flex", alignItems:"center", justifyContent:"center", padding:mob?"24px 20px":48 }}>
        <div style={{ maxWidth:400, width:"100%" }}>
          <h3 style={{ fontSize:24, fontWeight:700, color:"#ffffff", margin:"0 0 8px" }}>Log in to your account</h3>
          <p style={{ fontSize:14, color:"#94a3b8", marginBottom:32 }}>Enter your email and password</p>
          ...
          <div style={{ textAlign:"center", marginTop:16 }}>
            <span onClick={function(){go("landing")}} style={{ fontSize:12, color:"#64748b", cursor:"pointer" }}>Back to home</span>
          </div>
        </div>
      </div>
    </div>
